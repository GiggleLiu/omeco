...
- `rw_weight`: Weight for read-write complexity (set to 20.0 for GPU)
...
# GPU optimization (CRITICAL: rw_weight=20)
ScoreFunction(tc_weight=1.0, sc_weight=1.0, rw_weight=20.0, sc_target=30.0)
